...
import 'package:flutter_reccuring_reminder/pages/input/google_auth.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        actions: [
          IconButton(
            onPressed: () {
              context.read<AuthClass>().logOut(context);
            },
